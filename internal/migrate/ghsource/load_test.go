...
// contentBoardJSON exercises the content mapping: a draft card with a creator,
// a zone, a Day/Sprint/Status value and a body carrying a description plus a
// log-marked note thread, and an issue card with an author,
...
// "- [timestamp]" header belongs to its body.
