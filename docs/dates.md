...
- A record is not a workspace: those cards do not drag, every write to them is refused before it leaves the browser, and today's traffic is not applied over them. The live cards beside them stay entirely workable.
