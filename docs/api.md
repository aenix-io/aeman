...
- A snapshot listing also carries **what the × took off that day**: a done card the grid × demoted into the previous sprint records the day it was taken off, and the record of that day shows it again (in the state it ended the day with). Today's board does not — the × is what takes it off today.
